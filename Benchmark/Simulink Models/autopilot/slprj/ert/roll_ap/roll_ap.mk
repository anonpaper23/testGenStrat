###########################################################################
## Makefile generated for Simulink model 'roll_ap'. 
## 
## Makefile     : roll_ap.mk
## Generated on : Mon Feb 03 08:13:53 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: .\roll_ap_rtwlib.lib
...
MODELREF_LINK_RSPFILE_NAME = roll_ap_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..
MODELREF_LINK_RSPFILE     = roll_ap_ref.rsp
...
MODELLIB                  = roll_ap_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = Heading_Mode_rtwlib.lib attitude_controller_rtwlib.lib 
...
INCLUDES_BUILDINFO = $(START_DIR)\slprj\ert\roll_ap;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\ert\_sharedutils;.\referenced_model_includes
...
DEFINES_UNSPECIFIED = -DMODEL=roll_ap -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=0 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DTID01EQ=0 -DPORTABLE_WORDSIZES
...
DEFINES_STANDARD = -DMODEL=roll_ap -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\slprj\ert\roll_ap\roll_ap.c
...
{$(START_DIR)\slprj\ert\roll_ap}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\roll_ap}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
