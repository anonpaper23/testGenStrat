###########################################################################
## Makefile generated for Simulink model 'attitude_controller'. 
## 
## Makefile     : attitude_controller.mk
## Generated on : Mon Feb 03 08:38:20 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: .\attitude_controller_rtwlib.lib
...
PRODUCT_NAME              = attitude_controller
MAKEFILE                  = attitude_controller.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = attitude_controller_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..\..\..
MODELREF_LINK_RSPFILE     = attitude_controller_ref.rsp
...
MODELLIB                  = attitude_controller_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = .\attitude_controller_rtwlib.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\slprj\ert\attitude_controller;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\ert\_sharedutils
...
DEFINES_UNSPECIFIED = -DMODEL=attitude_controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=0 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DTID01EQ=0 -DPORTABLE_WORDSIZES
...
DEFINES_STANDARD = -DMODEL=attitude_controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\slprj\ert\attitude_controller\attitude_controller.c $(START_DIR)\slprj\ert\attitude_controller\attitude_controller_data.c
...
OBJS = attitude_controller.obj attitude_controller_data.obj
...
{$(START_DIR)\slprj\ert\attitude_controller}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\attitude_controller}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
