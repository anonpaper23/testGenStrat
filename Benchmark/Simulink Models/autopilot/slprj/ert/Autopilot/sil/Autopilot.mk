###########################################################################
## Makefile generated for Simulink model 'Autopilot'. 
## 
## Makefile     : Autopilot.mk
## Generated on : Mon Feb 03 08:39:06 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: Autopilot.exe
...
MODELREF_LINK_RSPFILE_NAME = Autopilot_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..\..
MODELREF_LINK_RSPFILE     = Autopilot_ref.rsp
...
INCLUDES_BUILDINFO = $(START_DIR)\slprj\ert\Autopilot;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\ert\_sharedutils;.\referenced_model_includes;$(MATLAB_ROOT)\toolbox\rtw\targets\pil\c;$(START_DIR)\slprj\ert\Autopilot\sil;$(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils
...
DEFINES_UNSPECIFIED = -DMODEL=Autopilot -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=0 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DTID01EQ=0 -DPORTABLE_WORDSIZES -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=100000 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
...
DEFINES_STANDARD = -DMODEL=Autopilot -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO

DEFINES = $(DEFINES_UNSPECIFIED) $(DEFINES_BUILD_ARGS) $(DEFINES_IMPLIED) $(DEFINES_OPTS) $(DEFINES_STANDARD)

###########################################################################
## SOURCE FILES
###########################################################################

SRCS = $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\xil_interface_lib.c $(START_DIR)\slprj\ert\Autopilot\sil\xil_interface.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\xil_rtio_data_stream.c $(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\sil_main.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\target_io.c $(MATLAB_ROOT)\rtw\c\src\rtiostream\rtiostreamtcpip\rtiostream_tcpip.c
...
OBJS = xil_interface_lib.obj xil_interface.obj xil_rtio_data_stream.obj rtiostream_utils.obj sil_main.obj target_io.obj rtiostream_tcpip.obj
...
MODELREF_LIBS = hostobj\Autopilot_rtwlib.lib hostobj\pitch_ap_rtwlib.lib hostobj\Altitude_Mode_rtwlib.lib hostobj\roll_ap_rtwlib.lib hostobj\Heading_Mode_rtwlib.lib hostobj\attitude_controller_rtwlib.lib hostobj\yaw_damper_rtwlib.lib

LIBS = ..\..\..\..\slprj\ert\_sharedutils\sil\hostobj\rtwshared.lib
...
{$(START_DIR)\slprj\ert\Autopilot}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Autopilot}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Autopilot\sil}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Autopilot\sil}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
