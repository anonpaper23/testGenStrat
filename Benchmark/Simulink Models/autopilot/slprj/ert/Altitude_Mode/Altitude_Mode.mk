###########################################################################
## Makefile generated for Simulink model 'Altitude_Mode'. 
## 
## Makefile     : Altitude_Mode.mk
## Generated on : Mon Feb 03 08:13:23 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: .\Altitude_Mode_rtwlib.lib
...
MODELREF_LINK_RSPFILE_NAME = Altitude_Mode_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..
MODELREF_LINK_RSPFILE     = Altitude_Mode_ref.rsp
...
MODELLIB                  = Altitude_Mode_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = .\Altitude_Mode_rtwlib.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\slprj\ert\Altitude_Mode;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\ert\_sharedutils
...
DEFINES_UNSPECIFIED = -DMODEL=Altitude_Mode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=0 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DTID01EQ=0 -DPORTABLE_WORDSIZES
...
DEFINES_STANDARD = -DMODEL=Altitude_Mode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\slprj\ert\Altitude_Mode\Altitude_Mode.c $(START_DIR)\slprj\ert\Altitude_Mode\Altitude_Mode_data.c
...
OBJS = Altitude_Mode.obj Altitude_Mode_data.obj
...
{$(START_DIR)\slprj\ert\Altitude_Mode}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Altitude_Mode}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
