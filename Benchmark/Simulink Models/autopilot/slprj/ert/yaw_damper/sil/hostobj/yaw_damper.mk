###########################################################################
## Makefile generated for Simulink model 'yaw_damper'. 
## 
## Makefile     : yaw_damper.mk
## Generated on : Mon Feb 03 08:38:25 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: .\yaw_damper_rtwlib.lib
...
MODELREF_LINK_RSPFILE_NAME = yaw_damper_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..\..\..
MODELREF_LINK_RSPFILE     = yaw_damper_ref.rsp
...
MODELLIB                  = yaw_damper_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
INCLUDES_BUILDINFO = $(START_DIR)\slprj\ert\yaw_damper;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\ert\_sharedutils
...
DEFINES_UNSPECIFIED = -DMODEL=yaw_damper -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=0 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DTID01EQ=0 -DPORTABLE_WORDSIZES
...
DEFINES_STANDARD = -DMODEL=yaw_damper -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\slprj\ert\yaw_damper\yaw_damper.c
...
{$(START_DIR)\slprj\ert\yaw_damper}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\yaw_damper}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
