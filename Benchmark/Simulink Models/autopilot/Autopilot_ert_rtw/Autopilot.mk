...
## Generated on : Mon Feb 03 08:14:03 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Autopilot.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Autopilot.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\Autopilot_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\ert\_sharedutils;.\referenced_model_includes
...
DEFINES_UNSPECIFIED = -DMODEL=Autopilot -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=0 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DTID01EQ=0 -DPORTABLE_WORDSIZES
...
SRCS = $(START_DIR)\Autopilot_ert_rtw\Autopilot.c

MAIN_SRC = $(START_DIR)\Autopilot_ert_rtw\ert_main.c
...
MODELREF_LIBS = .\pitch_ap_rtwlib.lib .\Altitude_Mode_rtwlib.lib .\roll_ap_rtwlib.lib .\Heading_Mode_rtwlib.lib .\attitude_controller_rtwlib.lib .\yaw_damper_rtwlib.lib
...
{$(START_DIR)\Autopilot_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Autopilot_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
